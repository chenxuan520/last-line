...
**灰炉城：** 2400m 高密工业城市，包含 448 栋建筑、54 栋 4–5 层厂办楼与工业塔楼、32 条二楼跨楼连廊。每个 seed 会确定性生成分段偏折的主干道、错位 T 字支路、大小混合的工业街区、退线院落、POI 和道路掩体，不再使用贯穿全图的正交棋盘路网；高楼每层、连廊桥面/护栏和门洞都属于服务端权威移动、射击遮挡与 AI 导航几何。
