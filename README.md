...
- 每局额外生成 16 座约 24–42m 高的山峰/山脊，据点优先落在谷地和平缓地带；山脚增加树木、灌木和岩石
- 建筑由带门窗开口的权威墙段组成，可进入、可交火，并通过外置坡道到达屋顶
- 60 秒随机航线、手动跳伞、适配大地图的滑翔和自动落地
- 步枪、冲锋枪、霰弹枪和狙击枪，统一即时命中和固定时间步规则；仅狙击枪支持右键瞄准镜
- 可见曳光、枪口焰、墙地火花、尘土和弹痕反馈
- 双主武器槽、弹药、两级护甲/头盔、绷带和急救包
- 49 名 AI 自主跳伞、搜集、进圈、战斗、换弹和治疗
- AI 在无可见敌人和有效物资时会持续选择圈内可达巡逻点；受击后立即转向攻击来源，楼上目标会沿坡道追击
- AI 按 16 个落区分流，开伞时机带独立随机扰动；物资总量固定 240，但各区按 seed 分配 10–20 件并采用不同间距，形成合理疏密
- 六阶段安全区、圈外伤害、击杀信息、唯一胜者和无刷新重开
- 前两圈保留搜集时间，第三圈起逐段加快等待与收缩，后期对局节奏明显提速
- 玩家被淘汰后自动切换到击杀者的第一人称视角；击杀者随后死亡时继续追踪新的击杀者
