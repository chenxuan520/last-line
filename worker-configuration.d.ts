/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.worker.jsonc` (hash: 202fe53b3b4cedf2b5b44d3d34fac0ef)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "LobbyDirectory" | "GameRoom";
	}
