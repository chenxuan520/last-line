/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.worker.jsonc types/worker-configuration.d.ts` (hash: 5b1051630dc910575c3fffc6ac1482ca)
// Runtime types generated with workerd@1.20260714.1 2026-07-20 
interface __BaseEnv_Env {
	LOBBY: DurableObjectNamespace<import("../worker/index").LobbyDirectory>;
	GAME_ROOMS: DurableObjectNamespace<import("../worker/index").GameRoom>;
	ACCOUNTS: DurableObjectNamespace<import("../worker/index").AccountDirectory>;
	ADMIN: DurableObjectNamespace<import("../worker/index").AdminDirectory>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../worker/index");
		durableNamespaces: "LobbyDirectory" | "GameRoom" | "AccountDirectory" | "AdminDirectory";
	}
