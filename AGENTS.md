...
- Avoid standalone plan-only commits. After implementation and required code review pass, update the relevant plan and engineering documentation before committing, and include those records with the implementation whenever practical.
