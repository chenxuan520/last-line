...
- Checkpoint version 7 accepts current island, town, and mixed rooms. Version 6 and older rooms use the previous authoritative stair/floor geometry and 250-record initial loot roster, so Worker and standalone must close and delete them instead of restoring.
