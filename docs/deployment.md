...
- A map-ID/protocol rollout must use the documented maintenance sequence: disable new multiplayer entry, drain/close rooms, deploy and smoke protocol 7 Worker, deploy matching Pages, re-enable entry, then smoke island and town rooms separately.
