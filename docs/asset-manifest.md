...
GLB metadata may adjust visual scale and offset only. Imported meshes are non-pickable. Authoritative hit capsules, line of sight, damage, fire rate, magazine size, grenade trajectory/fuse/radius/damage, and inventory behavior are defined by the rule layer and cannot be changed through the manifest.
